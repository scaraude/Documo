...
export const FolderForm = ({ isLoading }: FolderFormProps) => {
  ...
  const [step, setStep] = useState<'selectType' | 'fillForm' | 'sendRequests'>(
    'selectType'
  );
      ...
      <Card className="text-center py-12">
        <CardContent>
          ...
          <p className="text-gray-500 mb-6">
            Vous devez d&apos;abord créer un type de dossier avant de pouvoir
            créer un dossier
          </p>
          <Button asChild>
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center space-x-4">
          ...
          <span
            className={`font-medium ${step === 'selectType' ? 'text-blue-600' : 'text-green-600'}`}
          >
          ...
          <span
            className={`font-medium ${step === 'sendRequests' ? 'text-blue-600' : 'text-gray-500'}`}
          >
          ...
          <Card>
            ...
            <CardContent>
              <p className="text-gray-600 mb-4">
                ...
                Vous pouvez maintenant envoyer des demandes de documents aux
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <p className="text-sm text-gray-600">
                Ajoutez les adresses email des personnes à qui vous voulez
