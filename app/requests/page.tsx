                    ...
                    <div className="flex justify-between items-center">
                        ...
                        <div className="hidden sm:flex items-center space-x-2">
                            <button
                                ...
                                className={`text-center p-3 rounded-lg transition-all duration-200 ${statusFilter === 'COMPLETED'
                            ...
                            <button
                                ...
                                className={`text-center p-3 rounded-lg transition-all duration-200 ${statusFilter === 'ACCEPTED'
                            ...
                            <button
                                ...
                                className={`text-center p-3 rounded-lg transition-all duration-200 ${statusFilter === 'PENDING'
                            ...
                            <button
                                ...
                                className={`text-center p-3 rounded-lg transition-all duration-200 ${statusFilter === 'REJECTED'
                            ...
                            <button
                                ...
                                className={`text-center p-3 rounded-lg transition-all duration-200 ${statusFilter === 'ALL'
