...
test.describe('Auth Feature E2E Tests', () => {
  ...
  test.describe('Login Flow', () => {
    ...
    test('should successfully login with valid credentials', async ({ page }) => {
      ...
      await expect(page.locator(`button:has-text("${TEST_USERS.verified.initials}")`).first()).toBeVisible();
    });
  ...
  test.describe('Signup Flow', () => {
    ...
    test('should successfully create account and show success', async ({ page }) => {
      await page.click('text=Sign up');
      ...
      const hasSuccess = await page.locator('text=Account created successfully').isVisible();
      const isLoginForm = await page.locator('h2:has-text("Sign In")').isVisible();
  ...
  test.describe('Email Verification', () => {
    test('should allow login with unverified account but show verification message', async ({ page }) => {
  ...
  test.describe('Session Management', () => {
    ...
    test('should allow access to protected routes when not implemented yet', async ({ page }) => {
  ...
  test.describe('Logout Functionality', () => {
    test('should successfully logout user', async ({ page }) => {
      ...
      await page.locator(`button:has-text("${TEST_USERS.verified.initials}")`).first().click();
      await page.click('text=Sign Out');
      
      // Should redirect to home or login page
      const currentUrl = page.url();
      expect(currentUrl === 'http://localhost:3000/' || currentUrl === 'http://localhost:3000/login').toBe(true);
