...
#### Critères d'acceptation
- [ ] Réduire l'usage des couleurs (bleu Documo pour les actions uniquement)
- [ ] Supprimer les statistiques redondantes ou les fusionner
- [ ] Conserver la présentation en liste accordéon (c'est bien)
- [ ] Utiliser le skill `frontend-design` pour la refonte
- [ ] Respecter le Brand Book
...
*Document généré le 14/02/2026 - Documo MVP Planning*
